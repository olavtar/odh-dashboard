...
import { Alert, AlertActionCloseButton, Form, Modal, Stack, StackItem } from '@patternfly/react-core';
...
import ServingRuntimeSizeSection
  from '~/pages/modelServing/screens/projects/ServingRuntimeModal/ServingRuntimeSizeSection';
import NIMModelListSection from '~/pages/modelServing/screens/projects/NIMServiceModal/NIMModelListSection';
import NIMModelDeploymentNameSection
  from '~/pages/modelServing/screens/projects/NIMServiceModal/NIMModelDeploymentNameSection';
...
const DeployNIMServiceModal: React.FC<DeployNIMServiceModalProps> = ({
  ...
  const submit = () => {
    ...
    Promise.all([
      createNIMSecret(namespace, NIM_SECRET_NAME, false, false, dashboardNamespace),
      createNIMSecret(namespace, NIM_NGC_SECRET_NAME, true, false, dashboardNamespace),
